...
The new detector is designed to be able to read data related to each individual interaction up to a rate of 100 kHz for Pb-Pb collisions and 400 kHz for pp collisions., a factor two higher than the requirements. The new detector will support two different readout modes. 
